...
import com.agrobourse.dev.domain.PersistentToken;
...
import com.agrobourse.dev.security.SecurityUtils;
...
import com.agrobourse.dev.web.rest.vm.KeyAndPasswordVM;
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getEmail().toLowerCase(), managedUserVM.getImageUrl(), managedUserVM.getLangKey(),managedUserVM.getProfil());
